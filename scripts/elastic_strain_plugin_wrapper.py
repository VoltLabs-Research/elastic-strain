#!/usr/bin/env python3
"""Volt plugin wrapper for ElasticStrain. STDOUT is reserved for the stub's
binary IPC protocol — never write there from Python or subprocesses.
...
def process(frame, config):
    ...
    with tempfile.TemporaryDirectory(prefix="elastic-strain-inline-") as scratch:
